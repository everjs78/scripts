...
IP.1 = 191.168.1.14
`
openssl req -new -key mykey.pem -out mykey_192_168_1_14.csr -config mykey_192_168_1_14.cnf

* csr 확인
openssl req -noout -text -in mykey_192_168_1_14.csr

* CA 인증 머신에서 local 인증서 발급
openssl x509 -req -in ./mykey_192_168_1_14.csr -CA ../root/test-rootCA.crt -CAkey ../root/test-rootCA.key -CAcreateserial -out my_192.168_1_14.crt -days 1000 -sha256 -extfile mykey_192_168_1_14.cnf -extensions req_ext


* 인증서 확인
openssl x509 -text -in my_192.168_1_14.crt 
...
* curl로 https 접속하기
 curl -v "https://192.168.1.14:10100/hello" --key "./mykey.pem" --cert "./my_192.168_1_14.crt" --cacert "./test-rootca.crt" --cert-type PEM
